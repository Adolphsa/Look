...
import com.zividig.look.MyApplication;
import com.zividig.look.utils.NetWorkUtil;
...
public class ApiManage {
    ...
    //缓存相关
    private static File httpCacheDirectory = new File(MyApplication.getContext().getCacheDir(),"zhihuCachesss");
